...
function run(mount, render, init, view) {
  var model = /* record */[/* contents */Curry._1(init, /* () */0)];
  var dispatch = function (command) {
    model[0] = Curry._1(command[0], model[0]);
    return Curry._1(render, Curry._2(view, model[0], dispatch));
  };
  return Curry._1(mount, Curry._2(view, model[0], dispatch));
}

function map$1(getter, setter, element, dispatch) {
  return Curry._1(element, (function (command) {
                var updater = command[0];
                return Curry._1(dispatch, /* SetState */[(function (b) {
                                var a = Curry._1(updater, Curry._1(getter, b));
                                return Curry._2(setter, a, b);
                              })]);
              }));
}
...
function mountHtml(at) {
  ...
  return (function (param, param$1) {
      return run(render, render, param, param$1);
    });
}
  ...
  var _element = function (elementName, props, children, dispatch) {
    var props$1 = List.fold_left((function (props, param) {
            if (param.tag) {
              var command = param[1];
              props[param[0]] = (function (_event) {
                  return Curry._1(dispatch, command);
                });
              return props;
            } else {
              props[param[0]] = param[1];
